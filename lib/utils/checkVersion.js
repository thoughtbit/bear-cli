...
exports.default = function (done) {
  ...
  if (!_semver2.default.satisfies(process.version, _package2.default.engines.node)) {
    return console.log(_chalk2.default.red('  You must upgrade node to >=' + _package2.default.engines.node + '.x to use bear-cli'));
  }
  ...
  (0, _request2.default)({
    ...
    if (!err && res.statusCode === 200) {
      ...
      if (_semver2.default.lt(localVersion, latestVersion)) {
        console.log(_chalk2.default.yellow('  A newer version of bear-cli is available.'));
        console.log();
        ...
        if ((0, _getPackager2.default)() === 'yarn') {
          console.log(_chalk2.default.green('  yarn global upgrade bear-cli'));
        } else {
          console.log(_chalk2.default.green('  npm update -g bear-cli'));
        }
      }
    }
    done();
